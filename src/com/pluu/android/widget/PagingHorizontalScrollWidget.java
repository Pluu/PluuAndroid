...
public class PagingHorizontalScrollWidget extends HorizontalScrollView
	...
	public PagingHorizontalScrollWidget(Context context) {
		super(context);
		setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.WRAP_CONTENT));
	}

	public PagingHorizontalScrollWidget(Context context, int maxItem,
			int itemWidth) {
		this(context);
